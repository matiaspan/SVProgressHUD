...
- (instancetype)initWithFrame:(CGRect)frame {
    if((self = [super initWithFrame:frame])) {
        ...
        self.shadowView.layer.shadowOpacity = .25;
...
- (void)updateHUDFrame {
    ...
    self.shadowView.bounds = CGRectMake(0.0f, 0.0f, MAX(self.minimumSize.width, hudWidth), MAX(self.minimumSize.height, hudHeight));
    ...
    //    self.shadowView.frame = self.hudView.frame;
...
#pragma mark - Helper
    ...
    - (void)fadeInEffects {
        ...
        self.shadowView.frame = self.hudView.frame;
        [self.hudView.superview addSubview:self.shadowView];
        [self.hudView.superview bringSubviewToFront:self.hudView];
        self.hudView.backgroundColor = [UIColor whiteColor];
        self.shadowView.layer.shadowPath = [UIBezierPath bezierPathWithRoundedRect:self.hudView.bounds cornerRadius:4].CGPath;
    }
